...
df_csv=pd.read_csv(r'C:\Users\gmartinez\Documents\Docs\coding\POR\par_report_la_2018_06_30.csv')

#MSSQL Connection
connMySQL = r'mysql+pymysql://cf:Vision2020@10.100.25.13/CF_Portfolio'
engineMy = create_engine(connMySQL)

state=['paid_off', 'defaulted', 'canceled','rescheduled']
...
df_csv=df_csv[(df_csv.snapshot_at==max_dt) & (~df_csv.state.isin(state))]

df_csv.to_sql('ExtrMonthEnd',engineMy,if_exists='replace')
