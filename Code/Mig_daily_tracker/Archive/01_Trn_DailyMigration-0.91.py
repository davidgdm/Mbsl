...
querystring ="""delete from t_daily_consolidated where snapshot_at=(select snapshot_at from [Extr_Dailysnapshot] group by snapshot_at);
insert into t_daily_consolidated select * from [Extr_Dailysnapshot_dec7];"""
